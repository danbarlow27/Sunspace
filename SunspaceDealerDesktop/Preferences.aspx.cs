            ...
            using (SqlConnection aConnection = new SqlConnection(sdsUsers.ConnectionString))
            {
                ...
                try
                {
                    ...
                    aCommand.CommandText = "UPDATE model_preferences SET "
                                            ...
                                            + "transom_type='" + ddl100TransomType.SelectedValue + "', "
                    ...
                    aCommand.CommandText = "UPDATE model_preferences SET "
                                            ...
                                            + "transom_type='" + ddl200TransomType.SelectedValue + "', "
                    ...
                    aCommand.CommandText = "UPDATE model_preferences SET "
                                            ...
                                            + "transom_type='" + ddl300TransomType.SelectedValue + "', "
                    ...
                    aCommand.CommandText = "UPDATE model_preferences SET "
                                            ...
                                            + "transom_type='" + ddl400TransomType.SelectedValue + "', "
